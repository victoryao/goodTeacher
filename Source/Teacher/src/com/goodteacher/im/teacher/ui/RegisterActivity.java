...
public class RegisterActivity extends BaseActivity {
	...
	Button btn_register;
	EditText et_username, et_password, et_email,et_password_confirm,et_lang,et_phone;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		et_password_confirm = (EditText) findViewById(R.id.et_passowrd_confirm);
		et_email = (EditText) findViewById(R.id.et_email);
		et_lang = (EditText) findViewById(R.id.et_lang);
	...
	private void register(){
		...
		String lang = et_lang.getText().toString();
		...
		if (TextUtils.isEmpty(lang)) {
			ShowToast(R.string.toast_error_lang_null);
			return;
		}
